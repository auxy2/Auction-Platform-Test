...
(function (a, b) {
  ...
  var c = (function () {
    ...
    e = function (a, b) {
      var d, e;
      for (d in b)
        b.hasOwnProperty(d) && ((e = c(d)), null !== e && (a.style[e] = b[d]));
      return a;
    },
    f = function (a, b) {
    ...
    p = function (a) {
      var c = b.innerHeight / a.height,
        ...
        e = c > d ? d : c;
      return (
        a.maxScale && e > a.maxScale && (e = a.maxScale),
    ...
    s =
      ...
      q.classList &&
      q.dataset &&
      -1 === r.search(/(iphone)|(ipod)|(android)/);
  s
    ? (q.classList.remove('impress-not-supported'),
      q.classList.add('impress-supported'))
    : (q.className += ' impress-not-supported ');
  var t = {},
    u = {
      width: 1024,
      height: 768,
    ...
    w = (b.impress = function (c) {
      if (!s) return { init: v, goto: v, prev: v, next: v };
      if (((c = c || 'impress'), t['impress-root-' + c]))
      ...
      var r = {},
        ...
        H = function (a, b) {
          var c = a.dataset,
            d = {
              translate: { x: f(c.x), y: f(c.y), z: f(c.z) },
              rotate: {
                x: f(c.rotateX),
                y: f(c.rotateY),
        ...
        I = function () {
          if (!D) {
            ...
            (b.content =
              ...
              b.parentNode !== a.head &&
                ((b.name = 'viewport'), a.head.appendChild(b));
            var g = B.dataset;
            (z = {
              ...
              e(q, { height: '100%', overflow: 'hidden' });
            var k = {
              position: 'absolute',
            ...
            e(B, k),
              ...
              (D = !0),
              j(B, 'impress:init', { api: t['impress-root-' + c] });
          }
        },
        J = function (a) {
          return (
            'number' == typeof a
              ? (a = 0 > a ? y[y.length + a] : y[a])
        ...
        L = function (a, c) {
          ...
          var g = {
              rotate: { x: -d.rotate.x, y: -d.rotate.y, z: -d.rotate.z },
              translate: {
                x: -d.translate.x,
                y: -d.translate.y,
                z: -d.translate.z,
          ...
          return (
            ...
            (x.scale === g.scale ||
              (x.rotate.x === g.rotate.x &&
                x.rotate.y === g.rotate.y &&
                x.rotate.z === g.rotate.z &&
                x.translate.x === g.translate.x &&
                x.translate.y === g.translate.y &&
                x.translate.z === g.translate.z)) &&
              (i = 0),
            (x = g),
            (w = a),
            b.clearTimeout(K),
        ...
        M = function () {
          var a = y.indexOf(w) - 1;
          return (a = a >= 0 ? y[a] : y[y.length - 1]), L(a);
        },
        N = function () {
          var a = y.indexOf(w) + 1;
          return (a = y.length > a ? y[a] : y[0]), L(a);
        };
      return (
        B.addEventListener(
          'impress:init',
        ...
        (t['impress-root-' + c] = { init: I, goto: L, next: N, prev: M })
      );
    });
  w.supported = s;
})(document, window),
    ...
    a.addEventListener(
      ...
      function (d) {
        ...
        a.addEventListener(
          ...
          function (a) {
            (9 === a.keyCode ||
              (a.keyCode >= 32 && 34 >= a.keyCode) ||
              (a.keyCode >= 37 && 40 >= a.keyCode)) &&
              a.preventDefault();
          },
          !1
        ),
          ...
          a.addEventListener(
            ...
            function (b) {
              for (
                var c = b.target;
                'A' !== c.tagName && c !== a.documentElement;
