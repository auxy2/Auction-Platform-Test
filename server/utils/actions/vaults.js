...
export async function apeInVault(
  { provider, contractAddress, amount },
  callback
) {
...
export async function apeOutVault(
  { provider, address, zapAddress, contractAddress, amount, wantTokenName },
  callback
) {
...
export async function depositInVault(
  ...
  try {
    ...
    const approvedAmount = await wantContract.allowance(
      address,
      contractAddress
    );
...
export async function withdrawFromVault(
  { provider, contractAddress, amount, wantTokenName },
  callback
) {
