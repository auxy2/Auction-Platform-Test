            ...
            <Card>
              ...
              <CardActions>
                <Link
                  ...
                  to={`/place-bid/${product.minBidAmount}/${encodeURIComponent(product.description)}/${product._id}/${product.startingBid}`}
                >
                  <Button variant="outlined">Place Bid</Button>
                </Link>
                <Link
                  component={RouterLink}
                  to={`/check-bid-history/${product._id}`}
                >
                  <Button variant="outlined">Check Last bids</Button>
                  <br />
                </Link>
              </CardActions>
            </Card>
