...
function AuctionLandingPage() {
  ...
  const backLoginContent = (
    <Stack rowGap={5} sx={{ width: 200 }}>
      <Button
        onClick={() => handleOpenLoginDialog('seller')}
        size="large"
        variant="contained"
        color="secondary"
      >
      ...
      <Button
        onClick={() => handleOpenLoginDialog('buyer')}
        size="large"
        variant="contained"
      >
        Buyer
  ...
  const backSignContent = (
    <Stack rowGap={5} sx={{ width: 200 }}>
      <Button
        onClick={() => handleOpenSignupDialog('seller')}
        size="large"
        variant="contained"
        color="secondary"
      >
      ...
      <Button
        onClick={() => handleOpenSignupDialog('buyer')}
        size="large"
        variant="contained"
      >
        Buyer
  ...
  const flipLoginCard = FlipCard({
    frontContent: 'Login',
    backContent: backLoginContent,
    selectedRole: selectedRole,
  });
  const flipSignCard = FlipCard({
    frontContent: 'SignUp',
    backContent: backSignContent,
    selectedRole: selectedRole,
  });
    ...
    <React.Fragment>
      ...
      <>
        ...
        >
          ...
          >
            Join us for an exciting auction of distressed properties, including
